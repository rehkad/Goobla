...
* [Bugs](https://github.com/moogla/moogla/issues?q=is%3Aissue+is%3Aopen+label%3Abug): issues where Moogla stops working or where it results in an unexpected error.
* [Performance](https://github.com/moogla/moogla/issues?q=is%3Aissue+is%3Aopen+label%3Aperformance): issues to make Moogla faster at model inference, downloading or uploading.
* [Security](https://github.com/moogla/moogla/blob/main/SECURITY.md): issues that could lead to a security vulnerability. As mentioned in [SECURITY.md](https://github.com/moogla/moogla/blob/main/SECURITY.md), please do not disclose security vulnerabilities publicly.
