...
func TestHost(t *testing.T) {
	cases := map[string]struct {
		...
		"proxy path":          {"https://example.com/goobla", "https://example.com:443/goobla"},
	}

	for name, tt := range cases {
		t.Run(name, func(t *testing.T) {
			t.Setenv("GOOBLA_HOST", tt.value)
...
func TestOrigins(t *testing.T) {
	...
	for _, tt := range cases {
		t.Run(tt.value, func(t *testing.T) {
			t.Setenv("GOOBLA_ORIGINS", tt.value)
...
func TestBool(t *testing.T) {
	...
	for k, v := range cases {
		t.Run(k, func(t *testing.T) {
			t.Setenv("GOOBLA_BOOL", k)
			if b := Bool("GOOBLA_BOOL")(); b != v {
...
func TestUint(t *testing.T) {
	...
	for k, v := range cases {
		t.Run(k, func(t *testing.T) {
			t.Setenv("GOOBLA_UINT", k)
			if i := Uint("GOOBLA_UINT", 11434)(); i != v {
...
func TestLoadTimeout(t *testing.T) {
	...
	for tt, expect := range cases {
		t.Run(tt, func(t *testing.T) {
			t.Setenv("GOOBLA_LOAD_TIMEOUT", tt)
...
func TestVar(t *testing.T) {
	...
	for k, v := range cases {
		t.Run(k, func(t *testing.T) {
			t.Setenv("GOOBLA_VAR", k)
			if s := Var("GOOBLA_VAR"); s != v {
...
func TestContextLength(t *testing.T) {
	...
	for k, v := range cases {
		t.Run(k, func(t *testing.T) {
			t.Setenv("GOOBLA_CONTEXT_LENGTH", k)
