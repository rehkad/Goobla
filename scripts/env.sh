...
MOOGLA_COMMON_BUILD_ARGS="--build-arg=VERSION \
    --build-arg=GOFLAGS \
    --build-arg=MOOGLA_CUSTOM_CPU_DEFS \
    --build-arg=MOOGLA_SKIP_CUDA_GENERATE \
    --build-arg=MOOGLA_SKIP_CUDA_12_GENERATE \
    --build-arg=CUDA_V12_ARCHITECTURES \
    --build-arg=MOOGLA_SKIP_ROCM_GENERATE \
    --build-arg=MOOGLA_FAST_BUILD \
