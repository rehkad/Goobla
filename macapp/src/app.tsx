...
import GooblaIcon from './goobla.svg'
...
export default function () {
  ...
  const command = 'goobla run llama3.2'
        ...
        {step === Step.WELCOME && (
          <>
            <div className='mx-auto text-center'>
              <h1 className='mb-6 mt-4 text-2xl tracking-tight text-gray-900'>Welcome to Goobla</h1>
        ...
        {step === Step.CLI && (
          <>
            <div className='mx-auto flex flex-col space-y-28 text-center'>
              ...
              <pre className='mx-auto text-4xl text-gray-400'>&gt; goobla</pre>
              <div className='mx-auto'>
                <button
                  onClick={async () => {
                    try {
