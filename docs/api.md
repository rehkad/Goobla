...
```json5
{
  "modelfile": "# Modelfile generated by \"moogla show\"\n# To build a new Modelfile based on this one, replace the FROM line with:\n# FROM llava:latest\n\nFROM /Users/matt/.moogla/models/blobs/sha256:200765e1283640ffbd013184bf496e261032fa75b99498a9613be4e94d63ad52\nTEMPLATE \"\"\"{{ .System }}\nUSER: {{ .Prompt }}\nASSISTANT: \"\"\"\nPARAMETER num_ctx 4096\nPARAMETER stop \"\u003c/s\u003e\"\nPARAMETER stop \"USER:\"\nPARAMETER stop \"ASSISTANT:\"",
...
Download a model from the moogla library. Cancelled pulls are resumed from where they left off, and multiple calls will share the same download progress.
...
Upload a model to a model library. Requires registering for moogla.ai and adding a public key first.
